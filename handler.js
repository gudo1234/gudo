...
if (!m.fromMem && m.text.match(/(@50492280729|owner|dueño|edar|killua)/gi)) {
let emot = pickRandom(["🍉", "👻"])
...
if (media === 'audio')
this.sendMessage(id, { audio: { url: vn }, contextInfo:{ mentionedJid:[user], "externalAdReply": { "thumbnail": apii.data, "title": `🌟ＷＥＬＣＯＭＥ🌟`, "body": `${user}`, "previewType": "PHOTO", "thumbnailUrl": null, "showAdAttribution": true,  sourceUrl: [md, nna, yt, nn, tiktok].getRandom()}},  ptt: true, mimetype: 'audio/mpeg', fileName: `error.mp3` }, { quoted: fkontak2 })
