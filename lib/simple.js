...
export function makeWASocket(connectionOptions, options = {}) {
  ...
  sendEvent: {
  async value(jid, name = "", description = "", startTime = "0253392451200", isCancelled = false, quotedMessageId) {
    ...
    }, { userJid: conn.user.id, quoted: { key: { id: quotedMessageId } } }); // Aquí se cita el mensaje
