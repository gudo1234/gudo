...
let pp = await this.profilePictureUrl(who, 'image').catch(_ => "https://qu.ax/casQP.jpg")

// Fake
global.fkontak = { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
global.fakeChannel = { contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: id_canal, serverMessageId: 100, newsletterName: wm }, externalAdReply: { title: wm, body: wm, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: imagen4, thumbnail: imagen1, sourceUrl: canal }}}, { quoted: m }
global.fake = { contextInfo: { mentionedJid: null, forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: id_canal, serverMessageId: '', newsletterName: wm }, externalAdReply: { title: wm, body: wm, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: pp, sourceUrl: canal }}}
  
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Super Bot WhatsApp', orderTitle: 'Bang', thumbnail: imagen4, sellerJid: '0@s.whatsapp.net' }}}
...
let fgif = {key: {participant : '0@s.whatsapp.net'}, message: {"videoMessage": { "title": wm, "h": `Hmm`, 'seconds': '999999999', 'gifPlayback': 'true', 'caption': 'xd', 'jpegThumbnail': fs.readFileSync('./Menu2.jpg')}}}
                             
let enlace = { contextInfo: { externalAdReply: {title: wm + ' 🐈', body: 'support group' , sourceUrl: canal, thumbnail: await(await fetch(imagen4)).buffer() }}}
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: 'xd', thumbnailUrl: imagen1, sourceUrl: canal }}}
...
global.canales = [canal, md, fb, ig][Math.floor(Math.random() * 4)]
global.welgata = [canal, md, fb, ig][Math.floor(Math.random() * 8)]
global.redesMenu = [canal, md, fb, ig][Math.floor(Math.random() * 12)]
global.accountsgb = [canal, md, fb, ig][Math.floor(Math.random() * 13)]

global.canalIdGB = ["120363285614743024@newsletter", "120363285614743024@newsletter", "120363285614743024@newsletter", "120363285614743024@newsletter"]
global.canalNombreGB = ["꙳🧧𓆩ίʑ᭘ɱί-ⲃⲟτ𓆪🧧꙳", "꙳🧧𓆩ίʑ᭘ɱί-ⲃⲟτ𓆪🧧꙳", "꙳🧧𓆩ίʑ᭘ɱί-ⲃⲟτ𓆪🧧꙳", "꙳🧧𓆩ίʑ᭘ɱί-ⲃⲟτ𓆪🧧꙳"]
