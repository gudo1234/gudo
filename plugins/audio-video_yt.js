...
if (!text) return conn.reply(m.chat, `${e} *Ejemplo:* ${usedPrefix + command} close eyes`,  m, null, )
m.react('🕒')
...
m.react('❌')
await conn.reply(m.chat, '${e} *Ocurrió un fallo, usar .play .spotify*', m, null, ) }}}    
}} catch {
m.react('❌')
return conn.reply(m.chat, '${e} *Ocurrió un fallo, usar .play .spotify*', m, null, )}
