...
if (!text) return conn.reply(m.chat,  `\`Ejemplo ${usedPrefix + command} bad bunny\``, m, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: wm, previewType: 0, thumbnail: img.getRandom(), sourceUrl: redes.getRandom()}}})
try {
