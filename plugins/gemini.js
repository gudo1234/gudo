...
if (!text) return m.reply(`Hola ${m.pushName}, en que puedo ayudarte hoy?`) 
let syst = `Actuaras como un Bot de WhatsApp el cual fue creado por Edar, tu seras IzumiBot.`
