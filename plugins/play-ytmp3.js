...
if (!args[0]) return conn.reply(m.chat, `${e} *Ejemplo:* ${usedPrefix + command} https://youtu.be/UWV41yEiGq0?si=VMB6Awak9hXmXDk8`, m)
let youtubeLink = '';
...
try {
const res = await fetch(`https://api.dorratz.com/v2/yt-mp3?url=${encodeURIComponent(args)}`)
