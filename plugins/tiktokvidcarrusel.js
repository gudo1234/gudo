...
conn.sendMessage(message.chat, { text: global.espere + `*${name}*\n> Si los resultados no son enviados, pruebe con ${usedPrefix + command}2`, contextInfo: { externalAdReply: {title: `${wm}`, body: `${await conn.getName(message.chat)}`, thumbnailUrl: imagen4, thumbnail: img.getRandom(), showAdAttribution: true, sourceUrl: canal}}} , { quoted: message })
    let results = [];
