...
export async function before(m, { conn, participants, groupMetadata }) {
    ...
    if (chat.welcome && m.messageStubType === 27) {
        ...
        try {
            await conn.sendFile(m.chat, wm, wel, img, canal, fkontak);
//await conn.sendFile(m.chat, img, "Thumbnail.jpg", wel, null)
    ...
    if (chat.welcome && m.messageStubType === 28) {
        ...
        try {
            ...
            await conn.sendFile(m.chat, wm, bye, img2, canal, fkontak);
//await conn.sendFile(m.chat, img2, "Thumbnail.jpg", bye, null)
    ...
    if (chat.welcome && m.messageStubType === 32) {
        ...
        try {
            ...
            await conn.sendFile(m.chat, wm, kick, img3, canal, fkontak);
