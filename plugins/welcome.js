...
if (media === 'stiker')
conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: `👋🏻ADIOS +${m.messageStubParameters[0].split`@`[0]}`, body: 'Esperemos que no vuelva -_-', mediaType: 2, sourceUrl: 'https://whatsapp.com/channel/0029VaXHNMZL7UVTeseuqw3H', thumbnail: img}}}, { quoted: m })

if (media === 'audio')
await this.sendMessage(m.chat, { audio: { url: vn2 }, mimetype: 'audio/mpeg', ptt: true, contextInfo: { externalAdReply: { title: `👋🏻 ADIOS +${m.messageStubParameters[0].split`@`[0]}`, body: 'Esperemos que no vuelva -_-', thumbnailUrl: null, thumbnail: img, showAdAttribution: true, sourceUrl: canal}}} , { quoted: fkontak })
  }
  }
