...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  ...
  if (!db.data.chats[m.chat].modohorny && m.isGroup) throw `🚩 *Modohorny desactivado, pidele a un admin que lo active*`;
  if (!args[0]) throw `Ejemplo: ${usedPrefix + command} https://www.xnxx.es/video-fslt53a/real_cfnm_a_caballo_polla_pov_estilo_consigue_corrida_en_hd`;
  try {
