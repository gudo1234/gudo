...
if (size.split('MB')[0] >= limit) return star.reply(m.chat, `El archivo pesa mas de ${limit} MB, se canceló la Descarga. \`Prueba con ${usedPrefix}play.1\``, m, rcanal).then(_ => m.react('✖️'))
...
handler.command = ['yta2', 'ytmp32', 'mp32']
handler.group = true;
//handler.limit = 1
